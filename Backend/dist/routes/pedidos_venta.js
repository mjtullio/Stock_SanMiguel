...
pedidosventRoutes.get('/muestraProveedores', authentication_1.verificarToken, (req, res) => {
    const body = req.body;
...
pedidosventRoutes.get('/muestraProv', authentication_1.verificarToken, (req, res) => {
    const body = req.body;
...
pedidosventRoutes.post('/updateProveedor', authentication_1.verificarToken, (req, res) => {
    const body = req.body;
...
pedidosventRoutes.post('/agregarProveedor', authentication_1.verificarToken, (req, res) => {
    const body = req.body;
