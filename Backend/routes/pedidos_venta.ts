...
pedidosventRoutes.get('/muestraProveedores', verificarToken ,(req: Request, res: Response) => {
    const body = req.body;
...
pedidosventRoutes.get('/muestraProv', verificarToken ,(req: Request, res: Response) => {
    const body = req.body;
...
pedidosventRoutes.post('/updateProveedor', verificarToken, (req: Request, res: Response) => {
    const body = req.body;
...
pedidosventRoutes.post('/agregarProveedor', verificarToken, (req: Request, res: Response) => {
    const body = req.body;
